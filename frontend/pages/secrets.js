      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-10 border-b border-zinc-800 pb-4">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-3xl text-zinc-100 font-bold tracking-tight">Secret Manager</h1>
          </div>
          <div className="flex gap-4">
            <a href="/" className="px-4 py-2 bg-zinc-800 hover:bg-zinc-700 text-zinc-100 rounded transition-colors text-sm font-medium">
              Containers
            </a>
          </div>
        </div>
